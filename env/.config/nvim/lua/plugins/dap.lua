-- source: https://www.youtube.com/watch?v=Ul_WPhS2bis
-- github: https://github.com/nikolovlazar/dotfiles/tree/main/.config/nvim/lua/plugins
-- idea of keybindings: form TJ
-- debugging:    :DapShowLog
...
return {
  {
    ...
    config = function()
      ...
      -- ==========================================
      -- ADD THIS SECTION: JavaScript/Node.js Debug Configuration
      -- ==========================================
      local dap = require('dap')

      -- First, try to find vscode-js-debug (comes with js-debug-adapter)
      ...
      if vim.fn.isdirectory(js_debug_path) == 1 then
        ...
        print("js-debug-adapter not found! Install it via :Mason")
      end
      -- ==========================================
